...
<html>
  ...
  <body>
   ...
   echo "<br>";
   echo str_repeat (str_replace("Hai","Halo ",$text), 4);
   
   
   
   echo "<h1>ARRAY PHP </h1>";
   //----------tipe data array----------
   $kontak = array('kucing','labalaba','singa','harimau');
   $nama   = ['jeno','jaemin','jisung'];
   ...
   $data2 = array( "istri"  => "belum ada" ,
	...
	$hewan = ['kucing','labalaba','singa','harimau','naga'];
	//---------- 1) for loop ----------
